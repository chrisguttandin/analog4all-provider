...
module.exports = (grunt) => {
    ...
    return {
        'analyze': {
            cmd: 'npx ng build --prod --source-map --stats-json && webpack-bundle-analyzer build/analog4all-provider/stats.json'
        },
        'build': {
        ...
        'verify': {
            cmd: `bundle-buddy build/analog4all-provider/*.js.map && \
